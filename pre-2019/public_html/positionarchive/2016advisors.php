				...
				<div class="wrapper style1">
					...
					<div class="container">
						<div class="row 200%">
							...
							<a href="#" class="image featured"><img src="images/2016bc/vince.jpg" alt="" /></a>
							</div>
								...
								<article id="main">
									<header>
										<h2>Vince Egalla</h2>
										<p>
											2017 | Economics | <a href="mailto:vce6bx@virginia.edu">vce6bx@virginia.edu</a>
										</p>
									</header>
									<section>
										<header>
											<h3>Why did you decide to run for this position?</h3>
										</header>
										<p>
									...
									<section>
										<header>
											<h3>What is your favorite OYFA memory?</h3>
										</header>
										<p>
									...
									<section>
											<h3>What did you do/plan to do this summer?</h3>
										<p>
					...
					<div class="container">
						<div class="row 200%">
							...
							<div class="4u 12u(mobile)" id="sidebar">
							<a href="#" class="image featured"><img src="images/2016bc/elexa.jpg" alt="" /></a>
							</div>
								<div class="8u 12u(mobile) important(mobile)" id="content">
								<article id="main">
									<header>
										<h2>Elexa Rallos</h2>
										<p>
											2017 | Biology | <a href="mailto:epr5fj@virginia.edu">epr5fj@virginia.edu</a>
										</p>
									</header>
									<section>
										<header>
							...
							<a href="2016council.php" class="button">Back to council page</a>
								</div>

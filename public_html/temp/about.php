...
<?php include 'header.php'; ?>
	...
	<body>
		...
		<div class="row-fluid" style="padding-bottom: 20px;"><div class="span12 ">
				...
				<div class="accordion-group">
					<div class="accordion-heading" >
						...
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
							<div class=" bw"><img src="collapse/about.jpg"></div>
						</a>
					...
					<div id="collapseOne" class="accordion-body collapse in" >
						<div class="accordion-inner" style="background-color:#FFFFFF">
							<p> <h1>Mission</h1> </p>
							<p> The Organization of Young Filipino Americans was founded in 1988 in order to heighten awareness and appreciation of the Filipino/Filipino American culture to its members and the greater UVA and Charlottesville communities.  It also serves as the liaison to the University of Virginia students as part of the Filipino Intercollegiate Networking Dialogue, consisting of universities along the East Coast.</p>
							<p><h1> The Beginning </h1></p> <p>
							...
							<p> <h1>The Present</h1>
								...
								OYFA has not changed much, with one exception: we now have a much larger membership than when it was founded. People are attracted to OYFA because of the closeness of its members. The familial atmosphere keeps OYFAns deeply rooted in the organization and the alumni coming back for more!</p>
						</div>
					</div>
				</div>
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
							<div class=" bw"><img src="collapse/faq.jpg"></div>
						</a>
					</div>
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner" style="background-color:#FFFFFF">
							<p><b>Q: Do you have to be Filipino to be in OYFA?</b></p>
							<p>
				...
				<div class="accordion-group">
					<div class="accordion-heading" >
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
							<div class=" bw"><img src="collapse/barriocol.jpg"></div>
						</a>
					</div>
					<div id="collapseThree" class="accordion-body collapse">
						<div class="accordion-inner" style="background-color:#FFFFFF">
							<p> <h1>Barrio Fiesta</h1> </p>
							<p>
